    ...
    <div className="min-h-screen bg-gray-50 flex font-sans">
      ...
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col">
        ...
        <nav className="mt-4 px-3 space-y-1">
          {/* Dashboard activo */}
          <button className="w-full flex items-center gap-3 px-3 py-2 rounded-xl bg-emerald-50 text-emerald-700 font-semibold text-sm">
          ...
          {/* Estaciones */}
          <button className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-gray-600 hover:bg-gray-50 text-sm">
        ...
        <div className="w-full max-w-7xl">
          ...
          <header className="mb-10 text-center md:text-left">
            ...
            <p className="text-emerald-600 mt-2 text-base">
              Bienvenido, aquí tienes un resumen del estado del sistema.
            </p>
          </header>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1 max-w-md">
                  Añade una nueva estación de monitoreo al sistema para empezar a
